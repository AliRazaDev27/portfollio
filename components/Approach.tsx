      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center   gap-4">
        <Card
         title="Planning & Strategy"
          ...
          description="We'll collaborate with you to create a strategy that works for you. We'll work with you to understand your needs and goals. We'll work with you to create a roadmap that works for you.">
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Developement & Progress Update" icon={<AceternityIcon order="Phase 2" />}
        description="Once we agree on a plan, I cue on my lofi playlist and dive right into coding.From inital sketches to polished code, i keep you updated at every step. ">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="This is where the magic happens! Based on approved design, I'll translate everything into fucntional code, building your website from groundup. ">
